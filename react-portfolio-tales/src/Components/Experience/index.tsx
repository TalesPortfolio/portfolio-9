        ...
        <ContentTabs>
          <Tab isActive={activeTab === 1}>
            ...
            <P>
              ...
              technological journey where the possibilities for learning and
              growth are endless. Whether developing effective solutions,
              exploring new technologies, or actively participating in inspiring
              projects, I am determined to make a difference as I continue my
          ...
          <Tab isActive={activeTab === 2}>
            ...
            <P>
              ...
              With a solid foundation in languages such as C, JavaScript,
              Vue.js, and React, I constantly seek challenges that expand my
              knowledge and skills.
            </P>
            <P>
              My journey at 42 is a unique opportunity for hands-on learning,
              problem-solving, and collaboration among peers. Along the way, I
              am focused on developing not only technical competencies but also
              a mindset oriented toward innovative solutions.
            </P>
            <P>
          ...
          <Tab isActive={activeTab === 3}>
            ...
            <P>
              ...
              valuable work experience. Eager to apply and expand my skills, I
              am on the lookout for roles that will allow me to contribute,
              learn, and grow in a professional setting. Open to diverse
              challenges, I am ready to embark on a journey where I can make a
              meaningful impact while honing my abilities. Let&apos;s connect
